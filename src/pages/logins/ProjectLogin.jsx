      ...
      <div className="relative z-10 w-full max-w-md px-4 sm:px-6">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-yellow-400 to-yellow-500 shadow-lg mb-4 sm:mb-6">
            <Briefcase size={24} className="sm:w-8 sm:h-8 text-[#1E2A38]" />
          </div>
          <h1 className="text-2xl sm:text-4xl font-bold text-white mb-1 sm:mb-2">Project Portal</h1>
          <p className="text-gray-300 text-xs sm:text-sm">Manage your projects efficiently</p>
        </div>
          ...
          <div className="pt-4 sm:pt-6 border-t border-yellow-500/20">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3 text-xs">
              <div className="bg-white/5 p-2 sm:p-3 rounded border border-yellow-500/20">
                ...
                <p className="text-yellow-400 font-semibold text-sm">project</p>
              </div>
              <div className="bg-white/5 p-2 sm:p-3 rounded border border-yellow-500/20">
                <p className="text-gray-400 text-xs">Password</p>
                <p className="text-yellow-400 font-semibold text-sm">project123</p>
              </div>
            </div>
          </div>
        </div>
